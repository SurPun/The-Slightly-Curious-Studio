...
export default function MerchCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setMerchName(initialValues.merchName);
    setMerchPrice(initialValues.merchPrice);
    setMerchQuantity(initialValues.merchQuantity);
    setErrors({});
  };
  const validations = {
    merchName: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Merch(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MerchCreateForm")}
      {...rest}
    >
      <TextField
        label="Merch name"
